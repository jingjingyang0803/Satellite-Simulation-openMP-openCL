...
////////////////////////////////////////////////////////////////////////
//    ¤¤ Physics on CPU with omp, Graphic renderingon GPU kernel ¤¤   //
//                                                                    //
...
void ocl_init(void) {
    ...
    // Create bufSats: satellites read only
    // This buffer will store the array of satellite structures on the device
    bufSats = clCreateBuffer(context, CL_MEM_READ_ONLY, satelliteBytes, NULL, &status);
    if (status != CL_SUCCESS) {
